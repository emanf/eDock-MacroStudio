...
class ChooseMultipleCommand(MacroCommand):
    id = "dialogs.choose_multiple"
    title = "Choose Multiple Options"
    category = DialogsCategory
    icon = "mc:e6b1"
    description = "Let the user choose multiple options."
    ...
    fields = [
        {
            ...
            "title": "Title",
            "value_type": "string",
            "default_value": "Choose Multiple Options",
        },
        {
            "name": "message",
            "title": "Message",
            "value_type": "string",
            "default_value": "Please choose one or more options",
        },
        {
            "name": "options_text",
            "title": "Options",
        ...
        },
        {
            ...
            "title": "Save Selected Options To Variable",
            "value_type": "variable",
            "default_value": "",
            "required": False,
        },
    ...
    def display_text(self, values=None):
        ...
        return f"choose multiple: {values.get('title')}"
    ...
    def execute(self, values=None, runtime=None):
        ...
        result = run_on_ui(
            ...
            str(values.get("title", "Choose Multiple Options") or "Choose Multiple Options"),
            str(values.get("message", "") or ""),
            options,
            str(values.get("default_values", "") or ""),
            True,
        )
...
def register_macro(registry):
    registry.register(ChooseMultipleCommand)