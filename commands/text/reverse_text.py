...
def build_reverse_text_preview(values):
    target_variable = str(values.get("target_variable", "") or "").strip() or "reversed_text"
    ...
    return {
        "value": f"{target_variable} = reverse({text_value})",
        "status": "info",
    }


class ReverseTextCommand(MacroCommand):
    id = "text.reverse"
    title = "Reverse Text"
    ...
    fields = [
        ...
        },
        {
            ...
            "required": False,
            "transient": True,
            "compute_value": build_reverse_text_preview,
        },
    ]
    ...
    def display_text(self, values=None):
        ...
        return f"reverse text -> {target_variable}"
...
def register_macro(registry):
    registry.register(ReverseTextCommand)
